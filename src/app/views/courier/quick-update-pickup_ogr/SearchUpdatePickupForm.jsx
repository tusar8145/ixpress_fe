...
<Grid item md={3} lg={4} sm={6} xs={6}> <TextField type="number"   tabIndex= {0}     ref={inputReference}  autoFocus  name="id_single" id="standard-basicc" value={id_single || ""} onChange={handleid_single} label="Barcode & Press Enter*  " /> </Grid> 
