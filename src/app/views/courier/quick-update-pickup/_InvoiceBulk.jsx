...
{props.invoice_print.map(item => (  
   ...
   <Grid xs={12} id='this_class_4' className="this_class_5"  > {props.select_action_1}
  ...
  <tr>
    ...
    <td>{item[0].recipient_name_21}</td>
    <td>{item[0].recipient_phone_20}</td>
    <td>{item[0].recipient_address_24}</td>
    <td>{item[0].i_relation}</td>
    <td>{item[0].i_relation_person}</td>        
    <td>{item[0].i_return_cause}</td>
    <td>{item[0].delivery_date}</td>
    <td>{item[0].otp_verified}</td>
  </tr>
</table>
     ...
     {/*<table style={{width: "100%", }}>
      <tbody> 
            ...
            <tr>
                  <td colspan="7" style={{width: "58.2255%", borderTop: "0px", fontSize:"8px"}}><b>HOTLINE1:</b> <x   style={{fontSize: "9px"}} >{business_hotline}</x><br></br><b>Address:</b> {business_address} </td>
            </tr>
      ...
      <table>
        ...
        <Grid item xs={12} id='this_class' className="this_class" style={{ backgroundColor: "white",   padding: "5px", borderRadius: "3px", }}>
        <div className="tracking this_class_5" id="tracking">
        ...
        <p style={{textAlign:"center", color:"red",fontSize:"16px"}}>Instant Update</p>
<br></br>
</Grid>
</>
))}
