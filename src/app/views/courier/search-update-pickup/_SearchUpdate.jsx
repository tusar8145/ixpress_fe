...
getSenderRecipient_excel: () => { 
  const jason = {
    ...
    collection_trxid:collection_trxid,
    charge_trxid:charge_trxid,
...
#Register Variables:
 ...
 --------------------------------------------Start recipient---------------------------------------------------------------*/
  ...
  const [state, setState] = useState({pickup_date_3:format(new Date(),'yyyy-MM-dd'),unique_upload_id:null, shipment_ref:null,  charge_trxid:null,   collection_trxid:null,  sender_phone_5:null,sender_name_6:null,sender_address_9:null,recipient_phone_20:null,recipient_name_21:null,recipient_address_24:null,sender_ref_no_4:null,});
  const {  pickup_date_3,sender_ref_no_4,unique_upload_id,shipment_ref,charge_trxid,collection_trxid,sender_name_6,sender_phone_5,sender_address_9,recipient_name_21,recipient_phone_20,recipient_address_24,} = state;
...
{/*----------------------------------------------Start sender--------------------------------------------------------------*/}
  ...
  <Grid item lg={3} md={3}  sm={12} xs={12}>
        ...
        title={user.is_delivery_boy !=1? "Sender  >" : ""}  >
        {user.is_delivery_boy !=1 && <>
             ...
             {user.is_delivery_boy !=1 && <>
              ...
              <TextField type="text" inputProps={ { readOnly: false, } } name="charge_trxid" id="standard-basic" value={charge_trxid || ""} onChange={handleChange} label="Charge trxid:  " />
              </> }
              {user.is_delivery_boy !=1 && <>
              <TextField   type="text" inputProps={ { readOnly: false, } } name="collection_trxid" id="standard-basic" value={collection_trxid || ""} onChange={handleChange} label="Collection trxid:  " />
              </> }
...
<br></br><br></br><br></br>
{((user.is_delivery_boy !=1 || user.is_marchant !=1)) &&
<>
{(user.is_marchant !=1 && user.is_delivery_boy !=1 ) &&
<>
...
<Grid item lg={3} md={3}  sm={12} xs={12}>
        <SimpleCard title={user.is_delivery_boy !=1? "Recipient  >" : ""}  >
