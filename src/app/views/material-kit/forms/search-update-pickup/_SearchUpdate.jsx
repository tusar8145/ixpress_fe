...
#Register Variables:
 ...
 --------------------------------------------Start recipient---------------------------------------------------------------*/
  ...
  const [state, setState] = useState({pickup_date_3:format(new Date(),'yyyy-MM-dd'), sender_phone_5:null,sender_name_6:null,sender_address_9:null,recipient_phone_20:null,recipient_name_21:null,recipient_address_24:null,sender_ref_no_4:null,});
